...
public class Task6DTO {
    ...
    public static Task6DTO from(Task6 task) {
        return Task6DTO.builder()
                .id(task.getId())
                .task(task.getTask())
    ...
    public static List<Task6DTO> from(List<Task6> tasks) {
        return tasks.stream().map(Task6DTO::from).toList();
    }
}
